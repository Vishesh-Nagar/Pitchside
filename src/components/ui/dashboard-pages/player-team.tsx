                ...
                <CardContent className="space-y-4">
                    {upcomingMatches.length > 0 ? (
                        upcomingMatches.map((match) => (
                            <div
                                key={match.id}
                                className="p-6 rounded-3xl bg-white/50 border border-white/20 hover:bg-white/70 transition-all duration-300 hover:shadow-xl"
                            >
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-3 max-h-96 overflow-y-auto">
                                {filteredMembers.map((member) => (
                                    <div
                                        key={member.id}
                                        className="flex items-center justify-between p-4 bg-white/50 rounded-2xl border border-white/20 backdrop-blur-sm hover:bg-white/70 transition-all duration-300"
                                    >
                                        <div className="flex items-center space-x-3">
                        ...
                        <CardContent className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    {invitations
                                        ...
                                        .map((invitation) => (
                                            <div
                                                key={invitation.id}
                                                className="flex items-center justify-between p-3 bg-yellow-50/80 rounded-2xl border border-yellow-200"
                                            >
                                                <div>
                            ...
                            <div className="text-center py-8">
                                ...
                                <p className="text-sm text-gray-500">
                                    Invite players via email to join your team
                                </p>
                            </div>
                        </CardContent>
                    </Card>
