                ...
                <Card className="backdrop-blur-xl bg-white/40 border border-white/30 rounded-3xl shadow-xl">
                    ...
                    <CardContent className="space-y-4">
                        {recentActivity.map((activity) => (
                            <div
                                key={activity.id}
                                className="flex items-start space-x-4 p-4 bg-white/50 rounded-2xl border border-white/20 backdrop-blur-sm"
                            >
                                <div
                                    className={`w-10 h-10 rounded-2xl flex items-center justify-center ${getActionColor(
                                        activity.type
                                    )}`}
                                >
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        <Button
                                            size="sm"
                                            className="rounded-xl text-xs px-3 py-1 bg-emerald-500 hover:bg-emerald-600"
                                        >
                                            Approve
                                        </Button>
                                    </div>
