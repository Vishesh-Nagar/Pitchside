...
import { Trophy, Calendar, MapPin, Users, Search, Star } from "lucide-react";
...
export const TournamentsPage = () => {
    ...
    const filteredTournaments = tournaments.filter((tournament) => {
        ...
        const matchesFilter =
            selectedFilter === "all" ||
            tournament.status.toLowerCase() === selectedFilter;
        ...
        <div className="space-y-8">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 text-lg">
                                Join competitive tournaments and showcase your
                                skills
                            </p>
                        </div>
                ...
                <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <div className="flex gap-2">
                            {["all", "open", "ongoing", "completed"].map(
                                (filter) => (
                                    <Button
                                        key={filter}
                                        variant={
                ...
                <Card className="backdrop-blur-xl bg-white/40 border border-white/30 rounded-3xl shadow-xl">
                    ...
                    <CardContent className="space-y-4">
                        {myTournaments.map((tournament) => (
                            <div
                                key={tournament.id}
                                className="p-6 bg-white/50 rounded-2xl border border-white/20 backdrop-blur-sm"
                            >
                                <div className="flex items-center justify-between">
                                    <div>
            ...
            <Card className="backdrop-blur-xl bg-white/40 border border-white/30 rounded-3xl shadow-xl">
                ...
                <CardContent className="space-y-6">
                    {filteredTournaments.map((tournament) => (
                        <div
                            key={tournament.id}
                            className="p-6 bg-white/50 rounded-2xl border border-white/20 backdrop-blur-sm hover:shadow-lg transition-all duration-300"
                        >
            ...
            <PaymentModal
                ...
                amount={
                    selectedTournament
                        ? parseInt(
                              selectedTournament.registrationFee.replace(
                                  /[^\d]/g,
                                  ""
                              )
                          )
