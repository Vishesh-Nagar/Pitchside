    ...
    const tournaments = [
        {
            ...
            description:
                "The biggest football tournament in Dhaka with teams from across the city competing for glory.",
        ...
        },
        {
            ...
            description:
                "Fast-paced knockout tournament with intense competition.",
            difficulty: "Advanced",
        ...
        },
        {
            ...
            description:
                "Weekend tournament perfect for smaller teams and quick games.",
        ...
        },
        {
            ...
            description:
                "Tournament focused on developing young talent under 21.",
            difficulty: "Beginner",
            features: [
                "Coaching Clinics",
                "Scouts",
        ...
        },
        {
            ...
            description:
                "Tournament exclusively for corporate teams and office leagues.",
            difficulty: "Intermediate",
    ...
    const filteredTournaments = tournaments.filter((tournament) => {
        const matchesSearch =
            ...
            tournament.organizer
                ...
                .includes(searchTerm.toLowerCase());
        const matchesCity =
            selectedCity === "All" || tournament.city === selectedCity;
        const matchesType =
            ...
            <div className="container mx-auto px-4 py-8 relative">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                        Compete in exciting football tournaments across
                        Bangladesh. From local competitions to professional
                        leagues.
                    </p>
                </motion.div>
