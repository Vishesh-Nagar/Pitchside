...
const Turfs = () => {
    ...
    const turfs = [
        {
            ...
            capacity: "22 Players",
            description:
                "Professional-grade football turf with state-of-the-art facilities and excellent drainage system.",
        },
        {
            id: 2,
            name: "Victory Ground",
            ...
            capacity: "14 Players",
            description:
                "Well-maintained natural grass field perfect for casual and competitive matches.",
        },
        {
            id: 3,
            ...
            capacity: "22 Players",
            description:
                "Premium sports complex with multiple fields, professional lighting, and comprehensive facilities.",
        },
        {
            id: 4,
            name: "Green Field",
            ...
            capacity: "10 Players",
            description:
                "Affordable option for small group matches with basic facilities.",
        },
        {
            id: 5,
            ...
            capacity: "22 Players",
            description:
                "Modern stadium with excellent facilities and sea view ambiance.",
        },
        {
            id: 6,
            ...
            capacity: "14 Players",
            description:
                "Scenic location with well-maintained natural grass and mountain views.",
        },
    ];
    ...
    const filteredTurfs = turfs.filter((turf) => {
        ...
        const matchesCity =
            selectedCity === "All" || turf.city === selectedCity;
        ...
        if (selectedPrice !== "All") {
            const [min, max] = selectedPrice
                .replace("৳", "")
                .split("-")
                .map((p) => (p.includes("+") ? Infinity : parseInt(p)));
            matchesPrice =
                turf.priceValue >= min &&
                (max === Infinity || turf.priceValue <= max);
        }
            ...
            <div className="container mx-auto px-4 py-8 relative">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                        Discover and book premium football turfs across
                        Bangladesh. From casual 5v5 games to professional
                        tournaments.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <div className="flex items-center space-x-4">
                        <Button
                            variant="outline"
                            className="rounded-2xl border-white/30 bg-white/20 hover:bg-white/40"
                        >
                                    ...
                                    <div className="absolute top-4 left-4">
                                        <Badge
                                            className={`${getTypeBadgeColor(
                                                turf.type
                                            )} rounded-2xl px-3 py-1 font-semibold shadow-lg backdrop-blur-sm`}
                                        >
                                            {turf.type}
                                        </Badge>
                                    </div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {turf.features
                                                ...
                                                .map((feature, idx) => (
                                                    <div
                                                        key={idx}
                                                        className="flex items-center bg-gray-100/80 rounded-2xl px-3 py-1"
                                                    >
                                                        {getFeatureIcon(
                                                            feature
                                                        )}
