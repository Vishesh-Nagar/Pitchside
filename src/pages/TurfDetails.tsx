...
const TurfDetails = () => {
    ...
    const turf = {
        ...
        description:
            "Premium football turf with state-of-the-art facilities. Our field features the latest artificial grass technology, professional lighting system, and comprehensive facilities including changing rooms, parking, and refreshment area.",
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {turf.amenities.map(
                                            (amenity, index) => (
                                                <Badge
                                                    key={index}
                                                    className="bg-emerald-100 text-emerald-700 border border-emerald-200 text-sm px-3 py-1"
                                                >
                                                    {amenity}
                                                </Badge>
                                            )
                                    ...
                                    {["18:00", "19:00", "20:00", "21:00"].map(
                                        (time) => (
                                            <Badge
                                                key={time}
                                                variant="outline"
                                                className="justify-center py-2 text-emerald-700 border-emerald-200"
                                            >
                                                {time}
                                            </Badge>
                                        )
