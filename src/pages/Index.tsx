    ...
    const features = [
        {
            ...
            description:
                "Discover premium football turfs near you with real-time availability",
            color: "bg-green-100",
        },
        {
            icon: Trophy,
        ...
        },
        {
            ...
            description:
                "Book turf slots instantly with our real-time booking system",
            color: "bg-orange-100",
        },
    ];
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg text-stone-600 mb-8 max-w-xl">
                                Book premium turfs across Bangladesh. Join
                                tournaments. Connect with players. All in one
                                platform.
                            </p>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-stone-600 max-w-2xl mx-auto text-lg">
                            Discover premium turfs in your area and book
                            instantly
                        </p>
                    </motion.div>
                                    ...
                                    <CardContent>
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center space-x-3">
                                                <div className="flex items-center">
                                                    <Star className="w-4 h-4 text-yellow-500 fill-current" />
                                                    <span className="text-stone-900 font-semibold ml-1">
                                                        {turf.rating}
                                                    </span>
                                                </div>
                                                <Badge
                                                    variant="secondary"
                                                    className="bg-stone-100 text-stone-700 rounded-full"
                                                >
                                                    {turf.type}
                                                </Badge>
                                            </div>
            ...
            <section id="features" className="py-20 px-4 bg-stone-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-stone-600 max-w-2xl mx-auto text-lg">
                            Experience the most advanced sports booking platform
                            designed for modern football culture
                        </p>
                    </motion.div>
                        ...
                        {features.map((feature, index) => (
                            ...
                            >
                                <Card className="bg-white border border-stone-200 hover:shadow-lg transition-all duration-300 h-full text-center rounded-3xl">
                                    <CardHeader>
                                        <div
                                            className={`w-16 h-16 mx-auto mb-4 rounded-2xl ${feature.color} p-4 group-hover:scale-110 transition-transform duration-300`}
                                        >
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-stone-600 mb-8 max-w-2xl mx-auto text-lg">
                            Join the TurfMaster community and experience the
                            future of sports booking today
                        </p>
            ...
            <footer className="py-12 px-4 bg-stone-900">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mt-8 pt-8 border-t border-stone-800 text-center text-stone-500 text-sm">
                        <p>
                            &copy; 2025 Pitchside. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
